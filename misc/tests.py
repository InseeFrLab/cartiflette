...
levels_year = [
    [y, dev.get_administrative_level_available_ign(year=y, verbose=False)]
...
martinique_mod["trans_geometry"] = martinique_mod.scale(
    xfact=1.85, yfact=1.85, origin=(0, 0)
).translate(-1134525, 3517169)
martinique_mod = martinique_mod.set_geometry("trans_geometry", crs=2154).drop(
