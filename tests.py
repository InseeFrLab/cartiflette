...
martinique = dev.get_shapefile_ign(level = "COMMUNE", field = "martinique")
...
reunion = dev.get_shapefile_ign(level = "COMMUNE", field = "reunion")
reunion_mod = reunion
...
guadeloupe = dev.get_shapefile_ign(level = "COMMUNE", field = "guadeloupe")
...
guyane = dev.get_shapefile_ign(level = "COMMUNE", field = "guyane")
guyane = guyane
guyane.crs = 2154
